...
var UserSchema = new mongoose.Schema(
  {
    ...
    profileName: { type: String, default: "", required: true },
    profileImg: { type: String, default: "", required: true },
    profileBio: { type: String, default: "" },
    profileWebsite: { type: String, default: "" },
    newsLetterFlag: { type: Boolean, default: true, required: true },
    newsLetterDisableOption: { type: Number, default: 1, required: true }, //1:  no longer want to receive these emails, 2: I never signed up for this mailing list, 3: The emails are inappropriate, 4: The emails are spam and should be reported, 5: Other
  },
  { timestamps: true }
);
